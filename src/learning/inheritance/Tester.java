...
import learning.inheritance.Employee;
import learning.inheritance.EmployeeService;

public class Tester extends Employee implements EmployeeService {
    ...
    public String research(String speedDev, int salary, int experience){
        if (speedDev.equals("2")) {
            return "Salary = " + salary;
        }
        return experience + " is too low experience to do this work as fast as you want";
    }
}
